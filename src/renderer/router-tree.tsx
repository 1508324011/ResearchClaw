...
interface CreateRouterTreeOptions {
  indexRedirectPath: '/dashboard' | '/papers';
...
export function createRendererRouteTree({
  indexRedirectPath,
  extraChildren = [],
}: CreateRouterTreeOptions): RouteObject[] {
  return [
    {
      path: '/',
      element: <RootLayout />,
      children: [
        { index: true, element: <Navigate to={indexRedirectPath} replace /> },
